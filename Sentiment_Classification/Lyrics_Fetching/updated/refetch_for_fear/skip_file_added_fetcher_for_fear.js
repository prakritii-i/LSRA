...
// ================= CONFIGURATION =================
const INPUT_CSV = "fear.csv"; // Input dataset
const OUTPUT_CSV = "fear_lyrics.csv"; // Lyrics fetched successfully
const FAILED_CSV = "failed_lyrics_fear.csv"; // Failed fetches
const SKIPPED_CSV = "skipped_fear_lyrics.csv"; // Already processed
const PROGRESS_FILE = "progress_fear.json"; // Resume support
