...
// ================= CONFIGURATION =================
const INPUT_CSV = "skipped_bihana_kobata.csv"; // Input dataset
const OUTPUT_CSV = "skipped_lyrics.csv"; // Lyrics fetched successfully
const FAILED_CSV = "failed_lyrics_skipped.csv"; // Failed fetches
const SKIPPED_CSV = "skipped_again.csv"; // Already processed
const PROGRESS_FILE = "progress_skipped.json"; // Resume support
