...
const OUTPUT_CSV = "muse_with_lyrics.csv"; // Lyrics fetched successfully
const FAILED_CSV = "failed_lyrics.csv"; // Failed fetches
const SKIPPED_CSV = "skipped_lyrics.csv"; // Already processed
const PROGRESS_FILE = "progress_smh.json"; // Resume support
