...
// ================= CONFIGURATION =================
const INPUT_CSV = "skipped_phase2.csv"; // Input dataset
const OUTPUT_CSV = "akipped_muse_with_lyrics.csv"; // Lyrics fetched successfully
const FAILED_CSV = "failed_akipped_lyrics.csv"; // Failed fetches
const SKIPPED_CSV = "skipped_again_lyrics.csv"; // Already processed
const PROGRESS_FILE = "progress_for_skipped.json"; // Resume support
